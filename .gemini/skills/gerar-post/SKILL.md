---
name: gerar-post
description: Gera copy, hashtags, roteiros de reels e descrições de imagem para posts no Instagram da Mahou Prints. Suporta product showcase, milestones, bastidores e trends.
---
...
"""
{Prompt ALWAYS IN ENGLISH, gerado agindo como um engenheiro de prompts especialista em Midjourney/Nano Banana. Analise a necessidade visual (ou a imagem de referência) em detalhes técnicos e crie um prompt descrevendo: 1) The main subject, 2) The scenario, 3) The art style/cinematography direction, 4) The lighting and colors. Use rich vocabulary, focused on aesthetics and separate the terms by commas.}
"""
