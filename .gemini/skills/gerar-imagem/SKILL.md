---
name: gerar-imagem
description: Gera imagens profissionais de produtos impressos em 3D usando Google Flow + Nano Banana Pro, com automação via Playwright MCP. Suporta batch e edição cirúrgica. Use para criar fotos hero, imagens em uso e de detalhe.
---
