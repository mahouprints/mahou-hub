...
export function makePrismaMock() {
  const txDelegate = {
    ...
    produtoFilamento: { deleteMany: vi.fn(), createMany: vi.fn() },
    produtoInsumo: { deleteMany: vi.fn(), createMany: vi.fn() },
    ...
    jobProducao: { createMany: vi.fn(), findUnique: vi.fn(), update: vi.fn(), delete: vi.fn() },
    recibo: { update: vi.fn(), findUniqueOrThrow: vi.fn() },
    reciboItem: { deleteMany: vi.fn() },
  };
