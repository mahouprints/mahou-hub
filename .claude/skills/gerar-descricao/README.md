...
## Arquivo principal
- [`SKILL.md`](./SKILL.md) — workflow completo (4 modos: gerar, gerar-batch, refinar, traduzir) + arquitetura generator-evaluator (fan-out Sonnet + curadoria Opus)
...
- [`content/marketplace/treino/`](../../../content/marketplace/treino/) — concorrentes + bancos de keywords
